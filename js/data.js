...
const DataDefaults = (() => {
  ...
  function buildVillage() {
    ...
    ev(m, 13, 8, "Elder", (e) => {
      e.pages[0] = page(
        { charset: "elder", moveType: "fixed", trigger: "action" },
        [
          {
            t: "text",
            name: "Elder Rowan",
            text: "Welcome to \\c[2]Meridian Village\\c[0], traveler.\nMonsters have been creeping out of the \\c[3]cave\\c[0]\nto the north. Be careful out there!",
          },
          {
            t: "text",
            name: "Elder Rowan",
            text: "Press [b]Z[/b] or [b]Enter[/b] to talk and confirm.\nPress [b]X[/b] or [b]Esc[/b] to open the menu.",
          },
        ],
      );
    });
    ev(m, 10, 11, "Villager", (e) => {
      e.pages[0] = page(
        { charset: "villager_m", moveType: "random", trigger: "action" },
        [
          {
            t: "text",
            name: "Villager",
            face: "villager_m",
            text: "The pond is lovely this time of year.\nJust don't fall in \\i[15]!",
          },
        ],
      );
    });
  ...
  function buildInterior() {
    ...
    ev(m, 5, 4, "Resident", (e) => {
      e.pages[0] = page(
        { charset: "villager_f", moveType: "random", trigger: "action" },
        [
          {
            t: "text",
            name: "Tilda",
  ...
  function newProject() {
    const proj = {
      ...
      plugins:
        typeof AtlasBuiltins !== "undefined" ? AtlasBuiltins.seed(1) : [],
      customChars: [],
      commandPresets: [],
      assets: { tiles: {} },
      tilesets: {},
      system: {
        ...
        uiHeight: 0,
        screenScale: 1.6,
        fontText: RA.FONTS[0].v,
        fontMenu: RA.FONTS[0].v,
        fontSize: 15,
        windowOpacity: 93,
        pixelMovement: true,
      ...
      classes: [
        {
          ...
          name: "Warrior",
          icon: 0,
          base: { mhp: 48, mmp: 10, atk: 13, def: 11, mat: 6, mdf: 7, agi: 8 },
          growth: {
            mhp: 9,
            mmp: 1.5,
            atk: 2.6,
          ...
          traits: [
            { type: "param", key: "atk", value: 110 },
            { type: "special", key: "critChance", value: 8 },
          ],
        ...
        },
        {
          ...
          name: "Mage",
          icon: 1,
          base: { mhp: 32, mmp: 24, atk: 7, def: 7, mat: 14, mdf: 11, agi: 9 },
          growth: {
            mhp: 5.5,
            mmp: 4,
            atk: 1.2,
          ...
          traits: [
            { type: "skill", key: "magic", value: 115 },
            { type: "element", key: "fire", value: 80 },
          ],
          learnings: [
            { level: 1, skillId: 1 },
            { level: 4, skillId: 3 },
        ...
        },
        {
          ...
          name: "Cleric",
          icon: 2,
          base: { mhp: 38, mmp: 20, atk: 9, def: 9, mat: 12, mdf: 13, agi: 7 },
          growth: {
            mhp: 7,
            mmp: 3.5,
            atk: 1.6,
          ...
          traits: [
            { type: "skill", key: "heal", value: 120 },
            { type: "state", key: "1", value: 50 },
          ],
          learnings: [
            { level: 1, skillId: 2 },
            { level: 2, skillId: 8 },
        ...
        },
        {
          ...
          name: "Rogue",
          icon: 3,
          base: { mhp: 40, mmp: 14, atk: 11, def: 8, mat: 8, mdf: 8, agi: 14 },
          growth: {
            mhp: 7.5,
            mmp: 2,
            atk: 2.2,
          ...
          traits: [
            { type: "param", key: "agi", value: 115 },
            { type: "special", key: "critChance", value: 12 },
          ],
          learnings: [{ level: 3, skillId: 4 }],
        },
      ],
      ...
      enemies: [
        {
          ...
          sprite: "slime",
          color: "#5aa84f",
          stats: { mhp: 34, atk: 10, def: 6, mat: 4, mdf: 4, agi: 6 },
          exp: 8,
          gold: 12,
        ...
        },
        {
          ...
          sprite: "bat",
          color: "#7a5a9a",
          stats: { mhp: 26, atk: 12, def: 4, mat: 6, mdf: 6, agi: 14 },
          exp: 10,
          gold: 14,
          actions: [{ skillId: 0, weight: 5 }],
        },
        {
          ...
          sprite: "orc",
          color: "#6a9a4a",
          stats: { mhp: 110, atk: 18, def: 11, mat: 6, mdf: 8, agi: 7 },
          exp: 40,
          gold: 80,
          actions: [
            { skillId: 0, weight: 5 },
        ...
        },
        {
          ...
          sprite: "ghost",
          color: "#9ab8d8",
          stats: { mhp: 44, atk: 8, def: 6, mat: 16, mdf: 14, agi: 10 },
          exp: 22,
          gold: 30,
          actions: [
            { skillId: 0, weight: 3 },
        ...
        },
        {
          ...
          sprite: "golem",
          color: "#8a8a96",
          stats: { mhp: 150, atk: 22, def: 18, mat: 4, mdf: 10, agi: 4 },
          exp: 60,
          gold: 120,
          actions: [{ skillId: 0, weight: 5 }],
        },
        {
          ...
          sprite: "wasp",
          color: "#d8b04f",
          stats: { mhp: 22, atk: 14, def: 4, mat: 4, mdf: 4, agi: 18 },
          exp: 9,
          gold: 10,
          actions: [
            { skillId: 0, weight: 5 },
        ...
        },
        {
          ...
          sprite: "wolf",
          color: "#50668a",
          stats: { mhp: 52, atk: 17, def: 8, mat: 4, mdf: 7, agi: 16 },
          exp: 20,
          gold: 24,
          actions: [
            { skillId: 0, weight: 6 },
        ...
        },
        {
          ...
          sprite: "shroom",
          color: "#a94f91",
          stats: { mhp: 58, atk: 8, def: 9, mat: 15, mdf: 14, agi: 5 },
          exp: 24,
          gold: 28,
          actions: [
            { skillId: 0, weight: 3 },
        ...
        },
        {
          ...
          sprite: "skeleton",
          color: "#b8ad91",
          stats: { mhp: 68, atk: 18, def: 12, mat: 5, mdf: 8, agi: 10 },
          exp: 28,
          gold: 34,
          actions: [
            { skillId: 0, weight: 5 },
        ...
        },
        {
          ...
          sprite: "imp",
          color: "#b7464f",
          stats: { mhp: 46, atk: 10, def: 7, mat: 19, mdf: 12, agi: 15 },
          exp: 30,
          gold: 38,
          actions: [
            { skillId: 0, weight: 2 },
        ...
        },
        {
          ...
          sprite: "crystal",
          color: "#50b9d0",
          stats: { mhp: 82, atk: 12, def: 17, mat: 18, mdf: 18, agi: 6 },
          exp: 36,
          gold: 48,
          actions: [
            { skillId: 0, weight: 3 },
        ...
        },
        {
          ...
          sprite: "serpent",
          color: "#4f9a72",
          stats: { mhp: 74, atk: 20, def: 10, mat: 10, mdf: 11, agi: 13 },
          exp: 34,
          gold: 42,
          actions: [
            { skillId: 0, weight: 5 },
