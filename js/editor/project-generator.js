    ...
    maps: [
      {
        ...
        layers: {
          ground: new Array(300).fill(0),
          decor: new Array(300).fill(0),
          decor2: new Array(300).fill(0),
          over: new Array(300).fill(0),
        },
        shadows: new Array(300).fill(0),
        passOv: new Array(300).fill(0),
        heights: new Array(300).fill(0),
        collision: { tiles: new Array(300).fill(null), masks: [] },
